			...
			switch(command) {
                ...
                case 'onlyadms':
                    ...
                    if (args[0] == 'on') {
				        ...
				        await client.reply(from, `Você esqueceu de colocar se quer ativado [On], ou desativado [Off].`, id)
			        }
			        break
                case 'figu':
				case 'figurinha':
		        ...
		        case 'math':
                    ...
                    if (typeof math.evaluate(mtk) !== "number") {
			        	await client.reply(from, `Você definiu mesmo uma conta? Isso não parece uma.`, id)
		         	} else {
                ...
                case 'lgbt':
		        	...
		        	var lvrq = 100 - lvpc
	          		if (args.length == 1 && isGroupMsg) {
		         		...
		         		await client.reply(from, `Você é ${lvpc}% ${guei} e ${lvrq}% ${twgui}.`, id)
                    }
		         	break
				case 'tiktok':

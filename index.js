			...
			switch(command) {
                ...
                case 'lgbt':
		            	...
		            	var lvrq = 100 - lvpc
			 	    	...
			 	    	client.sendMessage(from, `Com base em meus estudos de Taxonomia e Quiropraxia, com os dados do meu cu, eu declaro que o ${args[0]} é ${lvpc}% ${guei} e ${lvrq}% ${twgui}.`, text)
        	 	     } else {
				 	 	reply(`Com base em meus estudos de Taxonomia e Quiropraxia, com os dados do meu cu, eu declaro que você é ${lvpc}% ${guei} e ${lvrq}% ${twgui}.`)
       	 	 	     }
		 	 	 	  break
				case 'meme':

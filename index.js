		...
		try {
			...
			break
		        ...
		        case 'gado':
			        ...
			        if (args.length == 1) {
			        	client.sendMessage(from, args[0] + ' é ' + lvpc + '% ' + gado + 'KKKKJ.')
			       } else {
                ...
                case 'ship':
		        	...
		        	client.sendMessage(from,  '❤️ ' + args[0] + ' tem um chance de ' + lvpc + '% de namorar ' + args[1] + '. 👩‍❤️‍👨')
		         	break	
                case 'gay':
                case 'lgbt':
		        	...
		        	var lvrq = 100 - lvpc
	          		if (args.length == 1 && isGroup) {
		         		client.sendMessage(from, `${args[0]} é ${lvpc}% ${guei} e ${lvrq}% ${twgui}.`)
                    } else {

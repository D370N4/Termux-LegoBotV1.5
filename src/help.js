...
➸ Comando : *${prefix}sticker*, *${prefix}stiker*, *${prefix}figurinha* ou *${prefix}figu*
...
➸ Comando : *${prefix}tts (sigla de idioma) [frase]*
➸ útil em : ele manda tudo que você escreve em áudio
➸ uso : basta enviar o comando\n
➸ Comando : *${prefix}lolifoda*
➸ útil em : mandar a imagem da capa do grupo Lolis & Lolicons
➸ uso : basta enviar o comando\n
➸ Comando : *${prefix}superpack*
➸ útil em : pack gigantesco de links do superhentais, escolha entre 1 a 5
➸ uso : basta enviar o comando\n
➸ Comando : *${prefix}donate*
➸ útil em : apoia o criador do bot pelo Kwai
➸ uso : basta enviar o comando\n
➸ Comando : *${prefix}wait*
...
➸ uso : ao enviar você pode escolher o formato entre 1 a 3, ou continuar com o convencional\n
➸ Nota : Você precisa ser administrador do grupo\n
➸ Comando : *${prefix}onlyadm*
➸ útil em : enviar o link do grupo
➸ uso : fecha o grupo ao colocar 0 e abre o grupo quando colocar 1\n
➸ Nota : O bot precisa ser admin\n
➸ Comando : *${prefix}add*
➸ útil em : adicionar membro ao grupo
➸ uso : *${prefix}add 5511xxxxx*\n
➸ Nota : o bot precisa ser admin!\n
➸ Comando : *${prefix}kick*
